 ...
 * 因此第二个参议员将被跳过因为他没有任何权利。然后在第二轮的时候，
...
public class PredictPartyVictory_649 {
    ...
    public static void main(String[] args) {
        PredictPartyVictory_649 victory = new PredictPartyVictory_649();

        System.out.println(victory.predictPartyVictory("RRDDRDDD"));
    ...
    public String predictPartyVictory(String senate) {
        ...
        while (!queueR.isEmpty() && !queueD.isEmpty()){
            ...
            if (rIndex < dIndex){
                // r序号小，把元素还添加到队列末尾，供下次使用
                queueR.offer(rIndex+n);
            }else {
                queueD.offer(dIndex+n);
            }
        }
